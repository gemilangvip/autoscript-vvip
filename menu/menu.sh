...
echo -e "${BICyan} │  ${BICyan}GITHUB    :  ${BIYellow}Github.com/gemilangvip${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
8) clear ; add-host ;;
9) clear ; running ;;
10) clear ; wget https://raw.githubusercontent.com/gemilangvip/autoscript-vvip/main/install-udp/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh ;;
11) clear ; xolpanel ;;
12) clear ; bw ;;
13) clear ; menu-theme ;;
14) clear ; update ;;
