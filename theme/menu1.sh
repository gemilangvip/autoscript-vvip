...
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "             ${BICyan}[${BIWhite}01${BICyan}] SSH and UDP   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
echo -e "             ${BICyan}[${BIWhite}02${BICyan}] VMESS or Xray   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
echo -e "             ${BICyan}[${BIWhite}03${BICyan}] VLESS or Xray   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
echo -e "             ${BICyan}[${BIWhite}04${BICyan}] TROJAN or Xray  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
echo -e "             ${BICyan}[${BIWhite}05${BICyan}] SETING or Libev ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
echo -e "             ${BICyan}[${BIWhite}06${BICyan}] TRIALL or Account  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"
